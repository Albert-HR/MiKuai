...
<body >
    ...
    <script type="text/javascript" >
        ...
        window.scrollTo(0, 0);
        if(src === ""){ 
            htmlPrd += `<div class="errmsg errmsg-s errmsg-m">No hay busqueda</div>`;
                        ...
                        prd.data.productos.forEach(function loop(prod) {
                                ...
                                <div style="padding: 1em;" class="w-s-100 w-m-33">
                                    ...
                                    <div class="bxprdct">
                                        ...
                                        <div class = "product" > <a href=" " onclick="loadProducto(event,${prod.id})" > <img src="data:image/*; base64,${prod.img}" alt=""> </a> </div>
